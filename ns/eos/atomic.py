...
from ..constants import CRITICAL_MAGNETIC_FIELD_GAUSS, ELECTRON_MASS_MEV, NEUTRON_MASS_MEV, PROTON_MASS_MEV
import numpy as np

class AtomicStarEOS(BaseEOS):
    """Standard atomic neutron star EOS."""
...
class MagneticAtomicStarEOS(BaseEOS):
    pass

class LSVAtomicStarEOS(BaseEOS):
    pass

class NLEMAtomicStarEOS(BaseEOS):
    pass